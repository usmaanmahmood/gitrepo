    ...
    if (!empty($database->getAttendancePattern())) {
        ...
        <table class="table table-striped table-hover table-bordered table-condensed">
            ...
            <tr>
                <td>Pattern</td>
                <td>
                    <div class="pull-right bg-info" style="margin: 10px; padding:20px;"><strong>Key:</strong><br/>
                        One line per week<br/>

                        <div class="green pull-left"></div>
                        : attended<br/>

                        <div class="orange pull-left"></div>
                        : excused<br/>

                        <div class="red pull-left"></div>
                        : absent<br/>

                        <div class="white pull-left"></div>
                        : no attendance taken
                    </div>
                    <?php

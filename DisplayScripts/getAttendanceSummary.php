        ...
        <tr>
            ...
            <td><div class="pull-right bg-info" style="margin: 10px; padding:20px;"><strong>Key:</strong><br />
                ...
                foreach ($splitPattern as $character) {
                    ...
                    if ($character == "|") {
                        $weekCount = 1;
                        echo "<br /><br /><div class=\"pull-left\">Semester Change</div><br /><span class=\"pull-left\" style=\"width:70px\">Week " . $weekCount . " </span>";
                        $lastWasSemester = 1;
                        continue;
                    } else if ($character == ".") {
                        if (!$lastWasSemester) {
                            $weekCount++;
                            echo "<br /><span class=\"pull-left\" style=\"width:70px\">Week " . $weekCount . " </span>";
                        }
                        continue;
                    }
                    else

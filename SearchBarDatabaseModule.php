...
<h2>Databases
    <button type="button" class="btn btn-default btn-xs btn-warning dat-reset-filters pull-right" style="margin-top:6px"><span
...
<div id="modulessearchsection">
    <h2>Modules
        <button type="button" class="btn btn-default btn-xs btn-warning mod-reset-filters pull-right" style="margin-top:6px"><span
                class="glyphicon glyphicon-remove"></span> Clear
        </button>
    </h2>

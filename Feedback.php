...
">Presentation</abbr></h4>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <button id="singlebuttonSubmit" name="singlebuttonSubmit" class="btn btn-primary btn-block btn-lg"><span class="glyphicon glyphicon-circle-ok"></span>Submit</button>
        </div>
    </div>
